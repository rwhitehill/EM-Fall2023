...
Specifying the surface charge density amounts to specifying the derivative of the potential over the surface:
\begin{eqnarray}
...
\begin{eqnarray}
    \eqbox{ \Phi(\va*{r}) = \frac{2 V}{\pi} \frac{R}{r} \sum_{l=0}^{\infty} \frac{(-1)^{l}}{2l+1} \Big( \frac{R}{r} \Big)^{l} P_{2l}(\cos{\theta}) }
.\end{eqnarray}
...
\begin{eqnarray}
    \eqbox{ \Phi(\va*{r}) = \frac{2 V}{\pi} \sum_{l=0}^{\infty} \frac{(-1)^{l}}{2l+1} \Big( \frac{r}{R} \Big)^{l} P_{2l}(\cos{\theta}) }
.\end{eqnarray}

(c) Lastly, we just need to find the total charge $Q$ on the disk in terms of $V$:
\begin{eqnarray}
    \eqbox{ C = \frac{Q}{V} = 8 \epsilon_0 R }
.\end{eqnarray}
...
\begin{eqnarray}
    \begin{aligned}
        \Phi(\va*{x}) &= \frac{q}{4 \pi \epsilon_0} \Bigg( \frac{1}{x} \Big[ 2 + \Big( \frac{a}{x} \Big)^2[3 \cos^2{\theta} - 1] + \frac{1}{32} \Big( \frac{a}{x} \Big)^{4} [ 20 \cos{4\theta} + 35 \cos{4 \theta} + 9 ] \Big] - \frac{2}{x} \Bigg) \\
                      &\approx \eqbox{ \frac{Q}{2 \pi \epsilon_0} \frac{1}{x^3} P_{2}(\cos{\theta}) }
    \end{aligned}
.\end{eqnarray}
...
\end{eqnarray}
since we can expand any contribution from an image charge or the induced surface charge density in legendre polynomials.
The terms $r^{-l-1}$ are not included though since there are no extra point charges inside the sphere which are not included in the second term.
We can find the coefficients $A_{l},B_{l}$ such that $\Phi \equiv 0$ on the shell:
\begin{gather}
    ...
    \sum_{l=0}^{\infty} A_{l} b^{l} P_{l}(\cos{\theta}) + \sum_{l=1}^{\infty} \frac{q}{2 \pi \epsilon_0 b} \Big( \frac{a}{b} \Big)^{2l} P_{2l}(\cos{\theta}) = 0
.\end{gather}
We then have
\begin{eqnarray}
    A_{2l} = -\frac{q}{2 \pi \epsilon_0 b^{2l + 1}} \Big( \frac{a^{2l}}{b^{2l}} \Big)^{2l}
\end{eqnarray}
for $l \geq 1$.
We also have $A_{0} = A_{2l+1} = 0$.
