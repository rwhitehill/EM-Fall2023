...
.\end{eqnarray}
Observe that the work $W = -q \Phi(\va*{r})$.

(b) The work needed to move a charge $q$ from $r > a$ to infinity in the presence of an isolated, conducting sphere with charge $Q$ on it is
\begin{eqnarray}
    \begin{aligned}
...
Again, the work is just 
\begin{eqnarray}
   \begin{aligned}
       W &= -q \Phi(\va*{r}) = \frac{q^2 a}{8 \pi \epsilon_0 (r^2 - a^2)} - \frac{q}{4 \pi \epsilon_0} \frac{Q - q'(r)}{r} \dd{r} \\
       &= \frac{1}{4 \pi \epsilon_0} \Big[ \frac{q^2 a}{2(r^2 - a^2)} - \frac{q Q}{r} + \frac{q^2 a}{2 r^2} \Big]
   \end{aligned} 
.\end{eqnarray}
