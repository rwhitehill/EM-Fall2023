...
(a) We can solve this problem by placing image charges $q'$ a distance $x$ from the center of the sphere and a charge $\hat{q}$ at the center of the sphere, where $q' + \hat{q} = q$.
...
\begin{eqnarray}
    \begin{aligned}
        F &= \frac{q}{4 \pi \epsilon_0} \Big[ \frac{q'}{(d - x)^2} + \frac{q - q'}{d^2} \Big] = \frac{q^2}{4 \pi \epsilon_0} \Bigg[ -\frac{R}{d} \frac{1}{(d - R^2/d)^2} + \frac{1 + R/d}{d^2} \Bigg] \\
...
\begin{gather}
   ...
   2 d^2 R^3 - R^5 > d^{5} - 2 d^3 R^2 + d R^{4} \\
   d^{5} - 2 d^3 R^2 - 2 d^2 R^3 + d R^{4} + R^{5} < 0
.\end{gather}
